...
export interface EksEksManagedNodeGroupOptions {
  /**
...
export class EksEksManagedNodeGroup extends TerraformModule {
  private readonly inputs: { [name: string]: any } = { }
  public constructor(scope: Construct, id: string, options: EksEksManagedNodeGroupOptions = {}) {
    super(scope, id, {
