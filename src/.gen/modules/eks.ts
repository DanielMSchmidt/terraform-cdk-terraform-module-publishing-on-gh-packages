...
export interface EksOptions {
   ...
   * @default true
   */
  readonly clusterEncryptionPolicyUseNamePrefix?: string;
  /**
   ...
   * @default true
   */
  readonly clusterSecurityGroupUseNamePrefix?: string;
  /**
   ...
   * @default true
   */
  readonly nodeSecurityGroupUseNamePrefix?: string;
  /**
...
export class Eks extends TerraformModule {
  ...
  public get clusterEncryptionPolicyUseNamePrefix(): string | undefined {
    return this.inputs['cluster_encryption_policy_use_name_prefix'] as string | undefined;
  }
  public set clusterEncryptionPolicyUseNamePrefix(value: string | undefined) {
  ...
  public get clusterSecurityGroupUseNamePrefix(): string | undefined {
    return this.inputs['cluster_security_group_use_name_prefix'] as string | undefined;
  }
  public set clusterSecurityGroupUseNamePrefix(value: string | undefined) {
  ...
  public get nodeSecurityGroupUseNamePrefix(): string | undefined {
    return this.inputs['node_security_group_use_name_prefix'] as string | undefined;
  }
  public set nodeSecurityGroupUseNamePrefix(value: string | undefined) {
